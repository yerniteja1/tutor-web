    ...
    <div className="p-6 space-y-6 bg-white border rounded-sm flex flex-col min-h-[calc(100vh-100px)]">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <Button
            className="bg-[#101828] gap-2 rounded-sm p-5"
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-64">
          <Input
            ...
            className="pl-3 bg-white rounded-sm"
          />
        </div>
        ...
        <Button variant="outline" className="rounded-sm border-dashed gap-2">
          <Plus size={14} className="rounded-full border border-black" />{" "}
          Designation
        </Button>
      </div>
          ...
          <TableHeader className="bg-gray-50">
            <TableRow>
              ...
              <TableHead className="text-xs text-gray-600">
                User ID <ChevronDown className="inline ml-1" size={12} />
              </TableHead>
              <TableHead className="text-xs text-gray-600">
                Name <ChevronDown className="inline ml-1" size={12} />
              </TableHead>
              <TableHead className="text-xs text-gray-600">
                Designation
              </TableHead>
              ...
              <TableHead className="text-xs text-gray-600">
                Status <ChevronDown className="inline ml-1" size={12} />
              </TableHead>
